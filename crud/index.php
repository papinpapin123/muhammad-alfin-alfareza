...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
        <div class="container">
            <a class="navbar-brand" href="index.php">Reza Arap | CRUD</a>
    ...
    <footer class="bg-dark text-white text-center" style="padding: 5px;">
        <p>Created with <i class=" "></i> by <u style="color: #fff;">Muhammad Reza</u></p>
    </footer>
    <!-- Close Footer -->
